        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formCliente" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label for="contatoCliente" class="control-label">Contato<span class="required">*</span></label>
                        <div class="controls">
                            <input id="contatoCliente" type="text" name="contatoCliente" value="<?php echo set_value('contatoCliente'); ?>" />
                        </div>
                    </div>
                    <div class="control-group">
