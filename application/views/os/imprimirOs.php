        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="invoice-content">
                    <div class="invoice-head" style="margin-bottom: 0;border-top:1px solid">
                        <table class="table table-condensed">
                            <tbody>
                                <?php if ($emitente == null) { ?>

                                    <tr style="border-top:1px solid">
                                        <td colspan="3" class="alert" style="border-top:1px solid">Você precisa configurar os dados do emitente. >>><a href="<?php echo base_url(); ?>index.php/mapos/emitente">Configurar</a>
                                            <<<</td> </tr> <?php } else { ?> <tr>
                                        <td style="width: 25%"><img src=" <?php echo $emitente[0]->url_logo; ?> " style="max-height: 100px"></td>
                                        <td> <span style="font-size: 20px; "> <?php echo $emitente[0]->nome; ?></span> </br><?php echo $emitente[0]->rua . ', ' . $emitente[0]->numero . ' - ' . $emitente[0]->bairro . ' - ' . $emitente[0]->cidade . ' - ' . $emitente[0]->uf; ?> </span> </br> <span> E-mail: <?php echo $emitente[0]->email . ' - Fone: ' . $emitente[0]->telefone; ?></span></td>
                        ...
                        <table class="table table-condensend">
                            <tbody>
                                <tr>
                                    <td style="width: 50%; padding-left: 0;border-top:1px solid">
                                        <ul>
                                            <li>
                                                <span>
                                                    <h5><b>CLIENTE</b></h5>
                    ...
                    <div style="margin-top: 0; padding-top: 0">
                        ...
                        <table class="table table-condensed">
                            <tbody>
                                ...
                                <?php { ?>
                                    <tr>
                                        <td colspan="5" style="border-top:1px solid; border-bottom: 1px solid">
                                            <b>DESCRIÇÃO: </b>
                                ...
                                <?php { ?>
                                    <tr>
                                        <td style="padding-top: 20px;border: none" colspan="5">
                                            <b>DEFEITO APRESENTADO: </b>
                                            <?php echo htmlspecialchars_decode($result->defeito) ?>
                                            <p style="border-bottom: 1px solid;height: 10px"></p>
                                            <p style="border-bottom: 1px solid;height: 10px"></p>
                                            <p style="border-bottom: 1px solid;height: 10px"></p>
                                            <p style="border-bottom: 1px solid;height: 10px"></p>
                                            <p style="border-bottom: 1px solid;height: 10px"></p>
                        ...
                        <table class="table table-bordered table-condensed">
                            <tbody>
                                <tr style="padding-top: 20px">
                                    <td  style="border: 1px solid">Data
                                        <p style="border-bottom: 1px solid;height: 30px"></p>
                                    </td>

                                    <td style="border: 1px solid">Assinatura do Cliente
                                        <p style="border-bottom: 1px solid;height: 30px"></p>
                                    </td>

                                    <td style="border: 1px solid">Assinatura do Técnico Responsável
                                        <p style="border-bottom: 1px solid;height: 30px"></p>
                                    </td>
                                </tr>
                            </tbody>
